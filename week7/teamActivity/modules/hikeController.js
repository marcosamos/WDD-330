...
export default class HikesController {
  ...
  constructor(parentId, commentParentId) {
    this.parentElement = document.getElementById(parentId);

    this.hikeModel = new HikeModel();
    this.hikesView = new HikesView(parentId);
    this.commentController = new commentController("hikes", commentParentId);
  ...
  showHikeList() {
    ...
    // tell controller to display hikes
    this.commentController.displayComments();
  }
  showOneHike(hikeName) {
    ...
    this.commentController.displayComments(hikeName);
  }
  // in order to show the details of a hike click we will need to attach a listener AFTER the list of hikes has been built. The function below does that.
  addHikeListener() {
