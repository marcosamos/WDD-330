...
export default class Hikes {
  ...
  addHikeListener() {
    let hikes = Array.from(this.parentElement.children);

    for(let hike of hikes){
      hike.addEventListener("click",event => this.showOneHike(event.currentTarget.dataset.name));
    }
...
function renderHikeList(parent, hikes) {
  hikes.forEach(hike => parent.appendChild(renderOneHikeLight(hike)));
}
